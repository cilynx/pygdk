...
def box(c_x, c_y):
    ...
    onefinity.rectangular_pocket(c_x, c_y, x=hollow_x, y=hollow_y, z_bottom=-hollow_z)
    ...
    onefinity.frame(c_x, c_y, x=width-sidewall, y=length-sidewall, z_bottom=-5, r=onefinity.tool.radius)
